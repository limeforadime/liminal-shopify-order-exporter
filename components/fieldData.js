export const fieldData = {
  main: [
    ...
    },
    {
      ...
      description: `Extra information that is added to the order. Each array entry must contain a hash with 'name' and 'value' "keys.  An array of json documents are valid as well as the Shopify export format.`,
    },
    {
      value: 'processed_at',
      name: 'Created at',
      description: `The date and time when the order was processed.  We recommend using ISO 8601 format when possible. This value c"an be set to dates in the past when importing from other systems. If no value i"s provided, it will be auto-generated based on the current date and time in Shopify.`,
    },
    {
      value: 'closed_at',
      name: 'Cancelled at',
      description: `The date and time when the order was closed. We recommend using ISO 8601 format when possible.  If the order was not closed, do not select this field.`,
    },
    {
      value: 'location_id',
      name: 'Location Id',
      description: `The ID of the physical location where the order was processed.  This has NO effect on the location of your fulfillments.`,
    },
  ],
  customer: [
    {
